        ...
        <div className='grid grid-cols-1 gap-8 lg:grid-cols-3'>
          ...
          <div className='flex justify-center flex-col items-center'>
            ...
            <p className='mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left'>
              ...
              <strong>{config?.nameCompany ?? 'Chúng tôi'}</strong>. Cam kết mang đến trải
                ...
                {config?.email && (
                  <li>
                    ...
                    >
                      ...
                      <span className='flex-1 text-gray-700'>{config.email}</span>
                    </Link>
                  </li>
                )}
                ...
                {config?.phone && (
                  <li>
                    ...
                    >
                      ...
                      <span className='flex-1 text-gray-700'>{config.phone}</span>
                    </Link>
                  </li>
                )}
        ...
        <div className='mt-12 border-t border-gray-100 pt-6'>
          <div className='text-center sm:flex sm:justify-between sm:text-left'>
            ...
            <p className='mt-4 text-sm text-gray-500 sm:order-first sm:mt-0'>
              &copy; {new Date().getFullYear()} w0wTeam - FPT Polytechnic Tay Nguyen
            </p>
          </div>
        </div>
      </div>
