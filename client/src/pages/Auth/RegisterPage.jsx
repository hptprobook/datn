        ...
        <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <form action="#" className="mt-12 grid grid-cols-6 gap-6">
              <InputField id="FirstName" label="Họ" name="first_name" />
              <InputField id="LastName" label="Tên" name="last_name" />
              ...
              <div className="col-span-6">
                <label htmlFor="MarketingAccept" className="flex gap-4">
                  ...
                  <span className="text-sm text-gray-700">
                    Tôi muốn nhận email về các sự kiện, cập nhật sản phẩm và các
                    thông báo của cửa hàng.
                  </span>
                </label>
              </div>
